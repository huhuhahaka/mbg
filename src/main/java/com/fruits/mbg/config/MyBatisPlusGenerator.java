...
public class MyBatisPlusGenerator {
    ...
    @Value("${mbg.datasource.driverName}")
    private String driverName;

    @Value("${mbg.datasource.url}")
    private String url;

    @Value("${mbg.datasource.username}")
    private String username;

    @Value("${mbg.datasource.password}")
    private String password;

    @Value("${mbg.package.base}")
    private String packageBase;

    @Value("${mbg.module.name}")
    private String moduleName;

    @Value("#{'${mbg.table.names}'.split(',')}")
    ...
    public void generator() {
        ...
        autoGenerator.setStrategy(initStrategyConfig(tableNames.toArray(new String[tableNames.size()])));
    ...
    private static GlobalConfig initGlobalConfig(String projectPath) {
        ...
        globalConfig.setAuthor("huhuhahaka");
